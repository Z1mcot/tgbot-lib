...
#include <tgbot/types/ForumTopicClosed.hpp>
#include <tgbot/types/ForumTopicReopened.hpp>
#include <tgbot/types/GeneralForumTopicHidden.hpp>
#include <tgbot/types/GeneralForumTopicUnhidden.hpp>
#include <tgbot/types/VideoChatStarted.hpp>
...
#include <tgbot/types/DirectMessagesTopic.hpp>
#include <tgbot/types/MessageOrigin.hpp>
#include <tgbot/types/ExternalReplyInfo.hpp>
#include <tgbot/types/TextQuote.hpp>
#include <tgbot/types/Story.hpp>
#include <tgbot/types/LinkPreviewOptions.hpp>
#include <tgbot/types/SuggestedPostInfo.hpp>
...
#include <tgbot/types/ChatOwnerLeft.hpp>
#include <tgbot/types/ChatOwnerChanged.hpp>
#include <tgbot/types/MessageAutoDeleteTimerChanged.hpp>
#include <tgbot/types/Invoice.hpp>
#include <tgbot/types/SuccessfulPayment.hpp>
#include <tgbot/types/RefundedPayment.hpp>
#include <tgbot/types/UsersShared.hpp>
#include <tgbot/types/ChatShared.hpp>
#include <tgbot/types/GiftInfo.hpp>
#include <tgbot/types/UniqueGiftInfo.hpp>
#include <tgbot/types/WriteAccessAllowed.hpp>
#include <tgbot/types/PassportData.hpp>
#include <tgbot/types/ProximityAlertTriggered.hpp>
#include <tgbot/types/ChatBoostAdded.hpp>
#include <tgbot/types/ChatBackground.hpp>
#include <tgbot/types/DirectMessagePriceChanged.hpp>
#include <tgbot/types/ForumTopicCreated.hpp>
#include <tgbot/types/ForumTopicEdited.hpp>
...
#include <tgbot/types/WebAppData.hpp>
